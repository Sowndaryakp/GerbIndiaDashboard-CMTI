...
const fetchMachineNames = async () => {
  const machinesUrl = 'http://172.18.100.33:6969/machines';
  try {
...
//   const url = `http://172.18.100.33:6969/production_data/live_data/?date=${selectedDate.value}&machine_id=${selectedMachine.value}`;
//   try {
...
const downloadDaywiseData = async () => {
  ...
  const url = `http://172.18.100.33:6969/production_data/live-data/?start_time=${epochLocalTime}&machine_id=${encodeURIComponent(selectedMachine.value)}&skip=0&limit=5000`;
...
const fetchDataForParameters = async () => {
  try {
    const endpoints = {
      plate_thickness: 'http://172.18.100.33:6969/elements',
      range: 'http://172.18.100.33:6969/elements',
      machine_id: 'http://172.18.100.33:6969/machines',
      welder_name: 'http://172.18.100.33:6969/welder/',
      project: 'http://172.18.100.33:6969/op_shift/',
      I_no: 'http://172.18.100.33:6969/op_shift/',
      Fc_no: 'http://172.18.100.33:6969/op_shift/',
      type: 'http://172.18.100.33:6969/elements',
      standard_current: 'http://172.18.100.33:6969/elements',
      standard_voltage: 'http://172.18.100.33:6969/elements',
      plate_thickness: 'http://172.18.100.33:6969/plate/plate',
      plate_description: 'http://172.18.100.33:6969/plate/plate',
    };
...
const submitForm = async () => {
  try {
    const response = await axios.get('http://172.18.100.33:6969/excel/', { params: formData.value });
