      ...
      <Production :dataFromParentProduction="ParentProductionData" class="h-96"  />
         ...
         <div v-if="nisPopupOpen" class="npopup">
          <div class="npopup-content">
            ...
            <button @click="nclosePopup" class="bg-red-500 text-white rounded-md w-16 ">Close</button>
          </div>
    </div>
       </div>
...
onMounted(async () => {
  ...
  for (const row of dataRows.value) {
    try {
      ...
      console.log(mostRecentElementType)
      ...
      console.log(mostRecentOperatorName)
      ...
      console.log("Stanadaradvoltagerange")
      row.standard.standard_current = standard_current;
      console.log(standard_current)
      console.log(row.standard.current)
      row.standard.standard_voltage = standard_voltage;
      row.range = range;

      // Display the standard current and voltage
      console.log("saddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd")
