        ...
        <tbody>
          <tr v-for="row in dataRows" :key="row.id" class="border-t hover:bg-white transition-colors">
            ...
            <td>
              <div class=" flex space-y-2 flex-col items-center  sm:px-4 sm:py-16 font-poppins">
                ...
                <!-- <div class="flex space-x-2">
                  <div v-if="!row.isEditing" type="text" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center"> {{ getoperatorIno(row.id) }}</div>
                  <div v-else><input v-model="row.I_no" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center"></div>
                </div>
                
                <div class="flex space-x-2 mt-2">
                  <div v-if="!row.isEditing" type="text" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center"> {{ getoperatorFcno(row.id) }}</div>
                  <div v-else><input v-model="row.Fc_no" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center"></div>
                </div>
                <div class="flex space-x-2 mt-2">
                  <div v-if="!row.isEditing" type="text" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center"> {{ getoperatorProject(row.id) }}</div>
                  <div v-else><input v-model="row.project" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center"></div>
                </div> -->
            ...
            <td class=" flex  flex-col items-center  sm:px-4 sm:py-16 font-poppins">
              ...
              <div class="mt-2">
                <textarea v-model="row.remarks" class="border border-gray-300 px-2 py-1 rounded-md"
            ...
            <td>
              ...
              <div class="mt-2 mb-2">
                <textarea v-model="row.remarks" class="border border-gray-300 px-1 py-1 rounded-md"
                  placeholder="Element Description"></textarea>
              </div>
              <div class="border border-gray-300 rounded-md w-26 px-2 py-2 sm:px-4 sm:py-2 mb-2 w-40 text-center">
                <b> {{ getMachineElementRange(row.id) }}</b>
              </div>
            </div>
            </td>
            <!-- <td>
              ...
              <div class="flex space-y-2 flex-col items-center mb-3 mt-3 font-poppins">
                <div class="border border-gray-300 px-4 py-6 rounded-md h-25 w-36">
                  ...
                  <div class="border border-gray-300 rounded-md ml-4 h-8 w-24">
                    <p class="text-lg text-blue-800 text-center font-bold "> {{ getMachineCurrent(row.id) }}A</p>
                  </div>
                </div>
                <div class="border border-gray-300 px-4 py-6 rounded-md h-25 w-36 ">
                  ...
                  <div class="border border-gray-300 rounded-md ml-4 h-8 w-24">
                    <p class="text-lg text-blue-800 text-center font-bold "> {{ getMachineVoltage(row.id) }}V</p>
                  </div>
                </div>
              </div>
            </td>
            ...
            <td>
              <div class=" flex space-y-2 flex-col items-center  sm:px-4 sm:py-16 font-poppins">
                <div class="flex space-x-2"><input v-model="row.I_no" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center" placeholder="I_No"></div>
                <div class="flex space-x-2 mt-2"><input v-model="row.Fc_no" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center" placeholder="Fc_No"></div>
                <div class="flex space-x-2 mt-2"><input v-model="row.project" class="border border-gray-300 px-4 py-2 rounded-md w-20 text-center" placeholder="Project"></div>
              </div>
            </td>
            ...
            <td class="font-poppins">
              ...
              <div class="flex space-x-2 mt-2">
                ...
                <button @click="generateReport()"
                  class="glassmorphic-button bg-purple-500 text-white px-2 py-1 rounded-md w-24 h-8"><i class="fa-solid fa-download"></i>
                  Report</button>
              </div>
            </div>
            </div>
