<template>
  ...
  <form @submit.prevent="submitForm" class="flex flex-wrap gap-4">
    ...
    <!-- <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md"><img width="20" height="20" src="https://img.icons8.com/ios-filled/50/FFFFFF/search--v1.png" alt="search--v1"/>Submit</button>
    <button @click="downloadExcel" class="mt-4 bg-green-500 text-white px-4 py-2 rounded-md">Download Excel</button> -->


<button type="submit"
        class="bg-blue-500 rounded-lg px-4 py-2 mt-3 mb-2 ml-3   text-white font-poppins flex flex-wrap">
        <!-- <img width="20" height="20" src="https://img.icons8.com/ios-filled/50/FFFFFF/search--v1.png" class="w-6 h-6 mr-2"  alt="search--v1"/> -->
    ...
    <button @click="downloadExcel" class="bg-green-500 rounded-lg px-4 py-2 mt-3 mb-2 ml-3 text-white font-poppins flex flex-wrap">
