...
const saveEditedWelder = async (index) => {
  ...
  try {
    const url = `http://172.18.100.54:6969/welder/${editedWelder.welder_name}?welder_number=${editedWelder.welder_number}`;
...
const deleteWelder = async (welder) => {
  try {
    const url = `http://172.18.100.54:6969/welder/${welder.welder_name}?welder_number=${welder.welder_number}`;
