<template>
  <div>
        ...
        <tbody>
          <tr v-for="(data, index) in tableData" :key="index">
            ...
            <td class="border px-4 py-2">
              ...
              <button @click="deleteData(data.machine_name, data.start_time, data.end_time)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
                Delete
              </button>
            </td>
          </tr>
    ...
    <select v-model="formData.machineName" required class="border border-gray-300 rounded-lg px-2 py-1 w-full" @click="fetchMachineNames">
...
<div class="mb-2">
  ...
  />
            ...
            <!-- <div class="mb-2">
              ...
              <select v-model="formData.shift" required class="border border-gray-300 rounded-lg px-2 py-1 w-full" @click="fetchShiftTypes">
...
const deleteData = (machineName, startTime, endTime) => {
  const url = `http://172.18.100.54:6969/op_shift/${machineName}/${startTime}/${endTime}`;
  axios
    .delete(url)
    .then(() => {
