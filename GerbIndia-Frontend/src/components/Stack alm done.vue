...
const downloadPDF = () => {
  const element = reportContainer.value; // Reference to the container you want to download
  const pdfOptions = {
    margin: 10,
    filename: 'report.pdf',
...
const downloadReport = () => {
  // Replace this with your actual report download logic
  alert(`Downloading report for ${selectedDate.value}`);
};
...
<div>
    ...
    ></datepicker>
    <button @click="downloadReport" v-if="selectedDate">
      Download Report
    </button>
  </div>


 <button @click="downloadPDF" class="bg-blue-500 text-white p-2 rounded-lg mt-4">
            Download Report
          </button>
<div class="bg-slate-100  rounded-md m-2 font-lexend    " ref="reportContainer">
    ...
    <div class="flex justify-between ">
      ...
      <div class="text-right bg-white rounded-lg shadow-lg w-40">
        <p class=" text-black font-bold text-xl mr-4 mt-1 h-8
         ">June 28, 2022</p>
        <p class="text-sm text-black font-semibold mr-12 mt-2 mb-2">14:18:11</p>
      </div>
    </div>
