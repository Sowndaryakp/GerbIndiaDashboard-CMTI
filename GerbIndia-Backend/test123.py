...
# Database setup
DATABASE_URL = "postgresql://Nihal_DB:Nihal6565@database-2.c3gqwccykmdf.eu-north-1.rds.amazonaws.com:5432/postgres"
...
# S3 client setup
s3 = boto3.client('s3',
                  aws_access_key_id="AKIAQ7XT3MLTJHHG3GYX",
                  aws_secret_access_key="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"
                  )
BUCKET_NAME = "tatapowers3"
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host="172.18.100.50", port=8000)